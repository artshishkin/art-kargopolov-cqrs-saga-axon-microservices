...
@TestPropertySource(properties = {
        ...
        "spring.datasource.url=jdbc:h2:mem:testDeadlineIT;DB_CLOSE_ON_EXIT=FALSE",
...
class DeadlineIT {
    ...
    @Test
    void createOrder_deadline() throws InterruptedException {
        //given
        ...
        log.debug("View in logs (current or another instance of `order-service`): `OrderCreatedEvent is handled`" +
                ...
                " followed by `Payment processing deadline took place` " +
